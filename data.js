// DATA.JS - TRƯỜNG TIỂU HỌC NGUYỄN AN KHƯƠNG (PHIÊN BẢN V2.4)
const TKB_CONFIG = {
  school: {
  ...
  subjectColors: {
    "TV": { bg: "bg-amber-100", border: "border-amber-300", text: "text-amber-900", badge: "bg-amber-500", name: "Tiếng Việt" },
    "Toán": { bg: "bg-blue-100", border: "border-blue-300", text: "text-blue-900", badge: "bg-blue-600", name: "Toán" },
    "ĐĐ": { bg: "bg-yellow-100", border: "border-yellow-300", text: "text-yellow-900", badge: "bg-yellow-500", name: "Đạo đức" },
    "TNXH": { bg: "bg-emerald-100", border: "border-emerald-300", text: "text-emerald-900", badge: "bg-emerald-600", name: "Tự nhiên và Xã hội" },
    "KH": { bg: "bg-teal-100", border: "border-teal-300", text: "text-teal-900", badge: "bg-teal-600", name: "Khoa học" },
    "LSĐL": { bg: "bg-orange-100", border: "border-orange-300", text: "text-orange-900", badge: "bg-orange-600", name: "Lịch sử và Địa lí" },
    "HĐTN(CC)": { bg: "bg-red-100", border: "border-red-300", text: "text-red-900", badge: "bg-red-600", name: "HĐTN (Chào cờ)" },
    "HĐTN(CĐ)": { bg: "bg-rose-100", border: "border-rose-300", text: "text-rose-900", badge: "bg-rose-500", name: "HĐTN (Chủ đề)" },
    "HĐTN(SHL)": { bg: "bg-purple-100", border: "border-purple-300", text: "text-purple-900", badge: "bg-purple-600", name: "HĐTN (SHL)" },
    "GDTC": { bg: "bg-green-100", border: "border-green-300", text: "text-green-900", badge: "bg-green-600", name: "Giáo dục thể chất" },
    "NT(MT)": { bg: "bg-pink-100", border: "border-pink-300", text: "text-pink-900", badge: "bg-pink-500", name: "Mĩ thuật" },
    "NT(ÂN)": { bg: "bg-cyan-100", border: "border-cyan-300", text: "text-cyan-900", badge: "bg-cyan-600", name: "Âm nhạc" },
    "CN": { bg: "bg-lime-100", border: "border-lime-300", text: "text-lime-900", badge: "bg-lime-600", name: "Công nghệ" },
    "TA": { bg: "bg-indigo-100", border: "border-indigo-300", text: "text-indigo-900", badge: "bg-indigo-600", name: "Tiếng Anh" },
    "TH": { bg: "bg-sky-100", border: "border-sky-300", text: "text-sky-900", badge: "bg-sky-600", name: "Tin học TH(2018)" },
    "IC3": { bg: "bg-violet-100", border: "border-violet-300", text: "text-violet-900", badge: "bg-violet-600", name: "Tin học Quốc tế IC3" },
    "CDS": { bg: "bg-fuchsia-100", border: "border-fuchsia-300", text: "text-fuchsia-900", badge: "bg-fuchsia-600", name: "Công dân số (CDS)" },
    "CLB Stem": { bg: "bg-teal-100", border: "border-teal-300", text: "text-teal-900", badge: "bg-teal-600", name: "CLB Stem" },
    "CLB KNS": { bg: "bg-amber-100", border: "border-amber-300", text: "text-amber-900", badge: "bg-amber-600", name: "CLB KNS" },
    "TA(BN)": { bg: "bg-blue-100", border: "border-blue-400", text: "text-blue-900", badge: "bg-blue-700", name: "Tiếng Anh Bản ngữ TA(BN)" },
    "TA(T-K)": { bg: "bg-cyan-100", border: "border-cyan-400", text: "text-cyan-900", badge: "bg-cyan-700", name: "Tiếng Anh Toán-Khoa TA(T-K)" },
    "CLB Toán TD": { bg: "bg-emerald-100", border: "border-emerald-400", text: "text-emerald-900", badge: "bg-emerald-700", name: "CLB Toán Tư duy" },
    "Tự học": { bg: "bg-slate-100", border: "border-slate-300", text: "text-slate-800", badge: "bg-slate-600", name: "Tự học/học có hướng dẫn" }
  },
  classes: {
